...
<?php echo $MSG_PROBLEM_ID?>:<input class='input-sm' type=text size=4 name=problem_id value='<?php echo $problem_id?>'>
<?php echo $MSG_USER?>:<input class='input-sm' type=text size=4 name=user_id value='<?php echo $user_id?>'>
...
echo " <input class='btn btn-lg btn-primary' type=submit value='$MSG_SEARCH' /></form>";
?>
</div>
