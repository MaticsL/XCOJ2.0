...
<head>
	...
	<link rel=stylesheet href='./template/<?php echo $OJ_TEMPLATE?>/<?php echo isset($OJ_CSS)?$OJ_CSS:"hoj.css" ?>' type='text/css'>
     <link rel="next" href="submitpage.php?<?php
        ...
        ?>">
	<script src="template/basic/jquery-1.9.1.min.js"></script>
...
<div id=main>
	...
	<?php
	if ($pr_flag){
		echo "<a class='btn btn-primary' href='submitpage.php?id=$id'>$MSG_SUBMIT</a>";
	}else{
		echo "<a class='btn btn-primary href='submitpage.php?cid=$cid&pid=$pid&langmask=$langmask'>$MSG_SUBMIT</a>";
	}
	echo "<a class='btn btn-default' href='problemstatus.php?id=".$row->problem_id."'>$MSG_STATUS</a>";
