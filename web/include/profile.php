...
header("Pragma: no-cache");
	...
	$profile="";
		if (isset($_SESSION['user_id'])){
				...
				$profile.= "<span class=' glyphicon glyphicon-user'></span><a href=./modifypage.php>$MSG_USERINFO</a>&nbsp;<a href='./userinfo.php?user=$sid'><span id=red>$sid</span></a>";
				$mail=checkmail();
				if ($mail)
					$profile.= "&nbsp;<i class=' glyphicon glyphicon-envelope'></i><a href=./mail.php>$mail</a>";
